...
var navBtns = document.querySelectorAll('.ui-tabs__tabslist li')
...
//   var currentClass = selected.className;
//   var currentTab = selected.dataset.tab;

//   // console.log(currentTab);
//   var init = 0;

//     if(currentTab === 'membership'){
//       document.querySelector('.ui.ui-tabs__content').innerHTML = membershipHTML;
//       selected.classList.toggle('ui-tabs__tab--selected');
//       navBtns.forEach(function(n){
//         if(n !== selected){
//           n.classList='ui-tabs__tab';
//         }
//       });
//     }else
//          if(currentTab === 'programs'){
//       document.querySelector('.ui.ui-tabs__content').innerHTML = programsHTML;
//       selected.classList.toggle('ui-tabs__tab--selected');
//       navBtns.forEach(function(n){
//         if(n !== selected){
//           n.classList='ui-tabs__tab';
...
//       });
//     }else
//         if(currentTab === 'screenings'){
//       document.querySelector('.ui.ui-tabs__content').innerHTML = screeningsHTML;
//       selected.classList.toggle('ui-tabs__tab--selected');
//       navBtns.forEach(function(n){
//         if(n !== selected){
//           n.classList='ui-tabs__tab';
...
//     }else
//       if(currentTab === 'press'){
//       document.querySelector('.ui.ui-tabs__content').innerHTML = pressHTML;
//       selected.classList.toggle('ui-tabs__tab--selected');
//       navBtns.forEach(function(n){
//         if(n !== selected){
//           n.classList='ui-tabs__tab';
